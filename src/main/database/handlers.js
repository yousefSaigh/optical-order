...
function updateOrder(id, orderData) {
  ...
  stmt.run(
    ...
    orderData.os_add, orderData.seg_height, orderData.frame_sku, orderData.frame_material,
    orderData.frame_name, orderData.frame_formula, orderData.frame_price, orderData.lens_design,
